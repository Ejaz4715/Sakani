    ...
    static Map<String, Map<String, String>> objects = new HashMap<>() {
        {
            ...
            put("View-booking", new HashMap<>() {{
                put("en", "");
                put("ar", "//span[text()='عرض الحجز']/parent::div");
            }});
            ...
            put("Pay-Fee-Button", new HashMap<>() {{
                put("en", "");
                put("ar", "//h6[contains(text(),'دفع رسوم الحجز')]");
            }});
            ...
            put("Project-Name", new HashMap<>() {{
                put("en", "");
                put("ar", "//app-collapse-box//h5");
            }});

            put("Unit-Code", new HashMap<>() {{
                put("en", "");
                put("ar", "//span[text() = 'رمز الوحدة']/parent::div/following-sibling::div/child::span");
            }});
