...
public class BookUnitPage {
    ...
    public void clickOnVerifyOTPButton() throws Exception{
        Browser.waitUntilVisibilityOfElement(RegistrationAndLoginPartnersPageObjects.VerifyOTPButton(), 30);
        Browser.waitUntilElementToBeClickable(RegistrationAndLoginPartnersPageObjects.VerifyOTPButton(), 30);
